...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'E:\\realtime-pizza\\node_modules\\socket.io\\dist\\index.js'");
...
/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! socket.io */ "./node_modules/socket.io/dist/index.js");
...
var cartCounter = document.querySelector('#cartCounter'); //let counter=document.getElementsByClassName('coun')[0].id
...
updateStatus(order);
var socket = io(); //let adminAreaPath=window.location.pathname
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //New updated time 
